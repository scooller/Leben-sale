...
return new class extends Migration
{
    ...
    {
        // Idempotent: skip column + FK creation if the column already exists
        // (handles cases where a previous partial migration left the column without
        // being recorded in the migrations table).
